...
namespace ImprovedEconomyForAILords
{
    internal class MCMSettings : AttributeGlobalSettings<MCMSettings>
    {
        ...
        [SettingPropertyInteger("{=IEFAIL_DYTASs}Caravans Denars Amount", 1000, 100000, Order = 2, RequireRestart = false, HintText = "{=IEFAIL_1Ek9CH}Amount of denars caravans will have when created. [Default: 8520]")]
        [SettingPropertyGroup("{=IEFAIL_fyyCjf}Caravans Settings", GroupOrder = 3)]
        public int CaravansDenarsAmount { get; set; } = 8520;

        [SettingPropertyBool("{=IEFAIL_Kiyniz}Enable AI Lords' Trade Experience", Order = 3, RequireRestart = false, HintText = "{=IEFAIL_ZcELyJ}Enable trade skill experience for AI lords with caravans. [Default: true]")]
        [SettingPropertyGroup("{=IEFAIL_fyyCjf}Caravans Settings", GroupOrder = 4)]
        public bool EnableAILordsTradeExperience { get; set; } = true;

        [SettingPropertyInteger("{=IEFAIL_NKMFnq}Trade XP Per Caravan Daily", 1, 100, Order = 4, RequireRestart = false, HintText = "{=IEFAIL_6wOF90}Base amount of trade experience per caravan that AI lords receive daily. [Default: 15]")]
        [SettingPropertyGroup("{=IEFAIL_fyyCjf}Caravans Settings", GroupOrder = 4)]
        public int TradeExperiencePerCaravanDaily { get; set; } = 15;

        [SettingPropertyBool("{=IEFAIL_1Kn8ZV}Consider Focus Points For Trade XP", Order = 5, RequireRestart = false, HintText = "{=IEFAIL_lUfWn9}When enabled, trade experience from caravans will be affected by focus points and attributes. [Default: false]")]
        [SettingPropertyGroup("{=IEFAIL_fyyCjf}Caravans Settings", GroupOrder = 4)]
